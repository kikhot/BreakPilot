...
export const ErrorCodes = Object.freeze({
  ...
  IDE_RESPONSE_TIMEOUT: "IDE_RESPONSE_TIMEOUT",
  IDE_DISCONNECTED: "IDE_DISCONNECTED",
  BRIDGE_PAYLOAD_LIMIT: "BRIDGE_PAYLOAD_LIMIT",
  ...
  EVIDENCE_INFRASTRUCTURE_UNAVAILABLE: "EVIDENCE_INFRASTRUCTURE_UNAVAILABLE",
